...
//		return Announcements();
	...
	/*
	 * public Pages.TestPages Test() { Test.click(); return TestPages;
	 * 
	 * }
	 */
	...
	public SchedulePage selectMyAccount() throws InterruptedException {
		/*
		 ...
		 */
		// driver.findElement(By.xpath("(//*[@class='anticon
		// anticon-caret-down'])[2]")).click();
		...
		System.out.println("Opened my account details.....");
	...
	public CoursePage selectCourseModule() throws InterruptedException {
		driver.findElement(By.xpath("//*[contains(@href,'/courses')]")).click();
