...
public class NotificationPage extends Aulas_Base.BaseTest
{
	...
	WebElement Close;
	 ...
	 /*****************************************************Notofication Module Teacher side*********************************/
	  public void clickOnNotification() {
		 ...
		 wait(5000);
		ele.click();
		System.out.println("Clicked on Notifications Module !!!");
	...
	public void checkAllNotications() {
		wait(3000);
		driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).click();
		wait(3000);
	System.out.println("Clicked on "+driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).getText()+"Successfully !!!!");
		
	List<WebElement> ele=driver.findElements(By.xpath("//*[@type='link']"));
	int sizeis=ele.size();
	System.out.println("The size of the view button is "+sizeis);
	for (int i=1;i<sizeis;i++) {
		wait(3000);
		driver.findElement(By.xpath("(//*[@type='link'])["+i+"]")).click();
		wait(3000);
		driver.findElement(By.xpath("//*[@data-icon='arrow-left']")).click();
		wait(3000);
	}
	}
	
	public void checkAnnouncementNotications() {
		wait(3000);
		driver.findElement(By.xpath("(//*[@class='m-l-20'])[2]")).click();
		wait(3000);
	System.out.println("Clicked on "+driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).getText()+"Successfully !!!!");
	...
	public void testNotications() {
		wait(3000);
		driver.findElement(By.xpath("(//*[@class='m-l-20'])[3]")).click();
		wait(3000);
	System.out.println("Clicked on "+driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).getText()+"Successfully !!!!");
	...
	public void feePaymentNotications() {
		wait(3000);
		driver.findElement(By.xpath("(//*[@class='m-l-20'])[4]")).click();
		wait(3000);
	System.out.println("Clicked on "+driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).getText()+"Successfully !!!!");
	...
	public void DLNotications() {
		wait(3000);
		driver.findElement(By.xpath("(//*[@class='m-l-20'])[5]")).click();
		wait(3000);
	System.out.println("Clicked on "+driver.findElement(By.xpath("(//*[@class='m-l-20'])[1]")).getText()+"Successfully !!!!");
	...
	public void dropDownCheck() {
		wait(3000);
		driver.findElement(By.xpath("//*[@class='ant-select-selector']")).click();
		wait(3000);
		
		List<WebElement> ele=driver.findElements(By.xpath("//*[@class='ant-select-item-option-content']"));
		int sizeiss=ele.size();
		System.out.println("The dropdown is "+sizeiss);
		for (int i=1;i<sizeiss;i++) {
			wait(3000);
			driver.findElement(By.xpath("(//*[@class='ant-select-item-option-content'])["+i+"]")).click();
			wait(3000);
			driver.findElement(By.xpath("//*[@class='ant-select-selector']")).click();
